...
class AndroidTest {
  ...
  void androidLaunchTest() throws MalformedURLException, InterruptedException {
    ...
    options.setDeviceName("janki-test-device");
    //options.setApp(System.getProperty("user.dir") + "C:\\beast2023\\projects\\apps\\Android-MyDemoAppRN.1.3.0.build-244.apk");
    options.setApp("C:\\beast2023\\projects\\apps\\Android-MyDemoAppRN.1.3.0.build-244.apk");
